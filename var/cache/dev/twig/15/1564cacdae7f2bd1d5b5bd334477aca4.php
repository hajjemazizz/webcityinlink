...
class __TwigTemplate_beceb212b131784522081f8b9e5d794c extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 10
        yield "    <div class=\"col-xl-3 col-md-6 mb-4 mt-3\">
        ...
        // line 16
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 16, $this->source); })()), "html", null, true);
        yield "</div>
                    </div>
                    <div class=\"col-auto\">
...
";
    ...
    {
        return array (  124 => 16,  116 => 10,  113 => 8,  103 => 7,  92 => 0,  82 => 5,  71 => 0,  61 => 3,  38 => 1,);
    }
...
{% endblock %}
", "admin/dashboard/index.html.twig", "C:\\Users\\Yosri Elhadj\\OneDrive - ESPRIT\\Bureau\\New folder (5)\\webcityinlink\\templates\\admin\\dashboard\\index.html.twig");
    }
}
